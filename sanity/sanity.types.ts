...
export type ALL_CATEGORIES_QUERYResult = {
  _id: string
  title: string | null
  color: string | null
}[]
...
export type ACTIVE_DAILY_PROMPTS_QUERYResult = {
  _id: string
  title: string | null
  prompt: string | null
  emoji: string | null
...
export type USER_JOURNAL_ENTRIES_QUERYResult = {
  _id: string
  title: string | null
  content:
    | (
...
export type USER_JOURNAL_ENTRIES_WITH_DATE_RANGE_QUERYResult = {
  _id: string
  title: string | null
  content:
    | (
