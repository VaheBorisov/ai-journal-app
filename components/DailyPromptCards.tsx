...
export default function DailyPromptCards() {
  ...
  return (
    <YStack gap="$3" mb="$4">
      <XStack style={{ alignItems: 'center', justifyContent: 'space-between' }} px="$1">
        <Text fontSize="$5" fontWeight="600" color="$color12">
          Daily Prompts
        </Text>
        <Pressable onPress={loadPrompts}>
          <IconSymbol size={20} name="arrow.clockwise" color={AppColors.gray500} />
        </Pressable>
      </XStack>
            ...
            >
              <YStack gap="$3" style={{ height: '100%' }}>
                ...
                <XStack gap="$2" style={{ alignItems: 'center' }}>
                  ...
                  {!prompt.emoji && (
                    <IconSymbol size={32} name="lightbulb.fill" color={AppColors.warning} />
                  )}
                  <Text
                    fontSize="$5"
                    fontWeight="600"
                ...
                {/* Prompt Text */}
                <Text fontSize="$4" color="$color11" style={{ flex: 1 }} numberOfLines={4}>
                  {prompt.prompt}
                </Text>
                ...
                >
                  ...
                  <XStack gap="$1" style={{ alignItems: 'center' }}>
                    <IconSymbol size={16} name="pencil.circle.fill" color={AppColors.primary} />
