...
export default function JournalEntryForm({
  ...
  const handleSave = async () => {
    ...
    if (!user?.id) {
      Alert.alert('Authentication error', 'Please sign in to save your journal entry.');
      return;
    }
    ...
    <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.moodBar}>
            {MOOD_OPTIONS.map(option => (
              <TouchableOpacity
                key={option.value}
                style={[styles.moodIcon, mood === option.value && styles.moodIconSelected]}
                onPress={() => setMood(option.value)}
              >
                <MaterialIcons
                  size={20}
                  name={option.icon as ComponentProps<typeof MaterialIcons>['name']}
      ...
      <View style={styles.toolbar}>
        <View style={styles.toolbarLeft}>
          ...
          {selectedMood && (
            <View style={styles.selectedMoodIndicator}>
              <MaterialIcons
                size={18}
                name={selectedMood.icon as ComponentProps<typeof MaterialIcons>['name']}
        ...
        <View style={styles.toolbarRight}>
          <TouchableOpacity disabled={isSaving} style={styles.cancelButton} onPress={onCancel}>
