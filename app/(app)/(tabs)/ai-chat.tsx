          ...
          <View style={styles.content}>
            ...
            >
              ...
              <YStack gap="$3" style={{ alignItems: 'center' }}>
                <H2 fontSize={28} fontWeight="700" style={{ textAlign: 'center' }}>
                  AI Chat Assistant
                </H2>
                <Text
                  fontSize={16}
                  ...
                  px="$4"
                >
                  Get intelligent insights, personalized journaling tips, and thoughtful
                  conversations about your entries
                </Text>
              </YStack>
                ...
                <YStack gap="$4">
                  <YStack gap="$3">
                    <View style={styles.featureRow}>
                      <MaterialIcons name="smart-toy" size={20} color="#904BFF" />
                      <Text fontSize={15} color="$color11" flex={1}>
                        Chat with AI about your journal entries
                      </Text>
                    </View>
                    <View style={styles.featureRow}>
                      <MaterialIcons name="insights" size={20} color="#904BFF" />
                      <Text fontSize={15} color="$color11" flex={1}>
                        Get personalized insights and suggestions
                      </Text>
                    </View>
                    <View style={styles.featureRow}>
                      <MaterialIcons name="psychology" size={20} color="#904BFF" />
                      <Text fontSize={15} color="$color11" flex={1}>
                        Discover patterns in your mood and habits
                      </Text>
                    </View>
                    <View style={styles.featureRow}>
                      <MaterialIcons name="lightbulb" size={20} color="#904BFF" />
                      <Text fontSize={15} color="$color11" flex={1}>
              ...
              <Text fontSize={13} color="$color9" style={{ textAlign: 'center' }}>
              ...
              {messages.length === 0 ? (
                <YStack gap="$4" style={{ alignItems: 'center' }} mt="$12">
                  ...
                  <Text
                    ...
                    px="$6"
                  >
                    Ask me about journaling tips, mood tracking, or just chat about your day
                  </Text>
                </YStack>
              ) : (
                messages.map(m => (
