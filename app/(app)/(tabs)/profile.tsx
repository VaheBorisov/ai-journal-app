...
import { Button, Card, H1, H2, ScrollView, Spinner, Text, View, XStack, YStack } from 'tamagui';
    ...
    <View style={styles.container}>
      ...
      >
        <YStack px="$4" gap="$4" pb={insets.bottom + 100}>
          {/* Profile Header Card */}
          <Card elevate size="$4" bordered bg="$background" borderColor="$borderColor" padding="$6">
            <YStack gap="$4" style={{ alignItems: 'center' }}>
              ...
              <YStack style={{ alignItems: 'center' }} gap="$2">
                <H1 fontSize={28} fontWeight="700" style={{ textAlign: 'center' }}>
                  {displayName}
                </H1>
            ...
            >
              <YStack gap="$3" style={{ alignItems: 'center' }}>
                <View style={styles.streakIconContainer}>
                  <IconSymbol size={24} name="flame.fill" color={AppColors.flameOrange} />
                </View>
            ...
            >
              <YStack gap="$3" style={{ alignItems: 'center' }}>
                <View style={styles.bestStreakIconContainer}>
                  <IconSymbol size={24} name="trophy.fill" color={AppColors.primary} />
                </View>
                <Text fontSize={36} fontWeight="800" color="$color12">
                  {longestStreak}
                </Text>
          ...
          {/* Subscription Card */}
          <Card elevate size="$4" bordered bg="$background" borderColor="$borderColor" padding="$5">
            <YStack gap="$4">
              <YStack gap="$2">
