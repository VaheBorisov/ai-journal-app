...
export default function EntryDetail() {
  ...
  if (error || !entry) {
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={styles.errorText}>{error || 'Something went wrong loading this entry.'}</Text>
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to delete your journal entry. Please try again.');
    } finally {
      setDeleting(false);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.timeText}>{formatTime(entry.createdAt ?? new Date())}</Text>
